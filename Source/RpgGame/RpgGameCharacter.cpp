...
void ARpgGameCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ARpgGameCharacter::Look);
...
void ARpgGameCharacter::DoMove(float Right, float Forward)
{
...
void ARpgGameCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ARpgGameCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ARpgGameCharacter::DoJumpEnd()
{
